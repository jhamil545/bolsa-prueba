    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php
                ...
                // Verifica si $_SESSION['SESSION_ROL'] está definido antes de acceder a él
                if (isset($_SESSION['SESSION_ROL']) && ($_SESSION['SESSION_ROL'] == '1' || $_SESSION['SESSION_ROL'] == '2' || $_SESSION['SESSION_ROL'] == '3')) {
                ?>

            <?php
                } else {
                    // Si $_SESSION['SESSION_ROL'] no está definido o no cumple con las condiciones, se agrega el elemento adicional al menú de navegación
                    ?>
            ...
            <!-- LISTAR USUARIOS (ROL => SUPER-ADMINISTRADOR/ADMINISTRADOR) -->
            <?php
            ...
            <!-- REGISTRAR EMPRESAS (ROL => SUPER-ADMINISTRADOR) -->
            <?php
                if (isset($_SESSION['SESSION_ROL']) && $_SESSION['SESSION_ROL'] == '1') {
                ?>
            ...
            <!-- LISTAR EMPRESAS (ROL => SUPER-ADMINISTRADOR/ADMINISTRADOR) -->
            <?php
                if (isset($_SESSION['SESSION_ROL']) && $_SESSION['SESSION_ROL'] == '1') {
                ?>
            ...
            <!-- REGISTRAR OFERTAS (ROL => ADMINISTRADOR) -->
            <?php
                if (session_status() === PHP_SESSION_NONE) {
                    session_start();
                }
            ...
            <?php
                    ...
                    // Código a ejecutar si $_SESSION['SESSION_ROL'] no está definido o no cumple con las condiciones
                }
            ?>

            <!-- LISTAR OFERTAS (TODOS LOS ROLES) -->
            <?php
                // Inicia la sesión si no se ha iniciado aún
                if (session_status() === PHP_SESSION_NONE) {
                    session_start();
            ...
            <?php
                    ...
                    // Si el rol es 4 (Postulante), cambia el título del enlace a "Mis Postulaciones"
                ?>
            <!-- Nav Item - Ofertas Laborales -->
            <li class="nav-item  ">
                <a class="nav-link" href="<?php echo RUTAGENERAL; ?>/source/oferta/listar_ofertas.php">
            ...
            <!-- LISTAR POSTULACIÓN (TODOS LOS ROLES) -->
            <?php
                // Inicia la sesión si no se ha iniciado aún
                if (session_status() === PHP_SESSION_NONE) {
                    session_start();
