...
<div class="container-fluid" align="center">
    ...
    <table class="table table-hover table-bordered">
        ...
        ?>
                    ...
                    <button onclick="eliminarOferta('<?php echo $fila['id']; ?>')" type="button" class="btn btn-danger" title="Eliminar"><i class="far fa-trash-alt"></i></button>

                    <button onclick="f_postular('<?php echo $fila['id']; ?>')" type="button" class="btn btn-primary" title="Agregar postulacion"><i class="fas fa-user-plus"></i></button>
